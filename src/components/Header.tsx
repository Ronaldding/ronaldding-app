    ...
    <>
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <div className="fixed top-12 right-0 w-64 h-full bg-white shadow-xl">
            <nav className="p-6">
              <ul className="space-y-4">
                <li>
                  <a href="/tools" className="block py-3 px-4 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors" onClick={closeMenu}>Tools</a>
                </li>
                <li>
                  <a href="/games" className="block py-3 px-4 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors" onClick={closeMenu}>Games</a>
                </li>
                <li>
                  <a href="/articles" className="block py-3 px-4 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors" onClick={closeMenu}>Articles</a>
                </li>
                <li>
                  <a href="https://tv.ronaldding.com" className="block py-3 px-4 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors" target="_blank" rel="noopener noreferrer" onClick={closeMenu}>TV</a>
                </li>
              </ul>
            </nav>
          </div>
