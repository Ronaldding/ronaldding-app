...
export default function Page() {
	const games: any[] = gamesData as any;
	return (
				...
				<section className="relative overflow-hidden bg-gradient-to-b from-purple-50 via-white to-white">
					<div className="mx-auto max-w-7xl px-6 sm:px-8 py-20">
						<div className="text-center">
							<h1 className="text-[clamp(2.5rem,8vw,4rem)] font-semibold tracking-tight text-gray-900">Games</h1>
							<p className="mt-6 text-xl text-gray-600 max-w-3xl mx-auto">Interactive entertainment experiences designed for fun and engagement.</p>
						</div>
					</div>
				</section>
				<section className="mx-auto max-w-7xl px-6 sm:px-8 py-16">
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						{games.map((game, index) => (<FeatureCard key={index} {...game} />))}
					</div>
					<div className="mt-16 text-center">
						<h2 className="text-2xl font-semibold text-gray-900 mb-4">More Games Coming Soon</h2>
						<p className="text-gray-600 max-w-2xl mx-auto">We're working on more exciting games and interactive experiences. Stay tuned for updates!</p>
					</div>
				</section>
			</main>
			<Footer />
